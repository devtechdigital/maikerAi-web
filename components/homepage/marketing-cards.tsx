...
const BusinessStages = [
  {
    ...
    description:
      "Early-stage ideas identifying problems worth solving. Perfect for aspiring entrepreneurs eager to start with minimal investment.",
    icon: "🔍",
    url: "/business-stages#problem-identification",
  ...
  },
  {
    ...
    name: "Early Concept",
    description:
      "Blueprints and initial plans ready for execution. Get a head start with a validated idea and clear roadmap.",
    icon: "💡",
    url: "/business-stages#early-concept",
  ...
  },
  {
    ...
    name: "MVP",
    description:
      "Minimum viable products with basic functionality. Ready to launch and gather user feedback for refinement.",
    icon: "🚀",
    url: "/business-stages#mvp",
  ...
  },
  {
    ...
    name: "Growth Stage",
    description:
      "Early revenue businesses with proven demand. Established customer base and clear path to scaling.",
    icon: "📈",
    url: "/business-stages#growth",
  ...
  },
  {
    ...
    description:
      "Established income streams with stable customer base. Optimized operations and proven business models.",
    icon: "🏆",
    url: "/business-stages#mature",
    ...
    <section className="py-20 max-w-7xl mx-auto px-4">
      <div className="grid place-items-center mb-16">
        ...
        >
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl text-center">
            Choose the business stage that aligns with your skills, risk tolerance, and investment level.
          </p>
        </motion.div>
      </div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {BusinessStages.map((stage, index) => (
          <motion.div
            ...
            viewport={{ once: true }}
            className="group relative overflow-hidden rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 hover:shadow-lg transition-shadow duration-300"
          >
            <div className="p-6">
              <div
                className={`inline-flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br ${stage.color} text-white text-2xl mb-4`}
              >
                {stage.icon}
              </div>
            ...
            <div
              className={`absolute inset-0 -z-10 opacity-0 group-hover:opacity-5 bg-gradient-to-br ${stage.color} transition-opacity duration-300`}
            />
          </motion.div>
        ))}
      </div>
      ...
      <div className="mt-12 text-center">
        <Link
          ...
          className="inline-flex items-center justify-center rounded-full bg-blue-600 px-6 py-3 text-white font-medium hover:bg-blue-500 transition-colors"
        >
